...
class MagicDataset(Dataset):
    ...
    @staticmethod
    def criar_mascara_disponibilidade(available, card_list):
        mascara = torch.zeros(324)
        card_to_index = {card: idx for idx, card in enumerate(card_list)}
    ...
    def __getitem__(self, idx):
        ...
        available = MagicDataset.string_para_lista(row['pack'])
