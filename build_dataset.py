...
if __name__ == '__main__':
    ...
    card_attr_df = read_data('Data/'+SET+'_cards_data.csv')

    ##filter best players
    output_file = "Data/draft_data_best_players.csv"
    ...
    '''
    ##process deck data
    #input_file = "Data/draft_data_best_players.csv"
    #output_file_stops = "Data/df_stops.csv"
    ...
    best_players_file = "Data/draft_data_best_players.csv"
    stops_file = "Data/df_stops.csv"
    output_file = "Data/draft_data_best_players_sc.csv"
